...
class ReadTest(unittest.TestCase):
    ...
    def setUp(self):
        self.cpio = cpiofile.open(self.cpioname, mode=self.mode)
...
class MiscReadTest(ReadTest):
    ...
    def test_extract_hardlink(self):
        ...
        cpio = cpiofile.open(cpioname, errorlevel=1)
...
class LongnameTest(ReadTest):
    ...
    def test_truncated_longname(self):
        ...
        fobj = StringIO.StringIO(self.cpio.fileobj.read(1536))
